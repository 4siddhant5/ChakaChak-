    ...
    <div className="p-4 sm:p-5 space-y-5 pb-24">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-xs">
          ...
          <span className="text-[10px] text-emerald-600 font-semibold">+₹1,100 peak surge</span>
        </div>
        ...
        <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-xs col-span-2 sm:col-span-1">
          ...
          <span className="text-[10px] text-blue-600 font-semibold">Top 5% Mumbai Earner</span>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-xs space-y-3">
        <div className="flex items-center justify-between">
          <h3 className="text-xs font-bold uppercase text-gray-700">Quality & Bonus Tier</h3>
        ...
        <div className="grid grid-cols-3 gap-2 text-center pt-1">
          <div className="p-2.5 rounded-2xl bg-gray-50 border border-gray-100">
            <span className="text-base font-black text-gray-900">4.92 ★</span>
            <span className="block text-[10px] text-gray-500 mt-0.5">Rating</span>
          </div>
          <div className="p-2.5 rounded-2xl bg-gray-50 border border-gray-100">
            <span className="text-base font-black text-gray-900">99.4%</span>
            <span className="block text-[10px] text-gray-500 mt-0.5">On-Time</span>
          </div>
          <div className="p-2.5 rounded-2xl bg-gray-50 border border-gray-100">
            <span className="text-base font-black text-gray-900">98%</span>
            <span className="block text-[10px] text-gray-500 mt-0.5">Acceptance</span>
          </div>
        </div>

        <div className="p-3 rounded-2xl bg-emerald-50 border border-emerald-200 flex items-center justify-between text-xs">
          <div>
            <span className="font-bold text-emerald-900">Weekend Mumbai Surge Bonus</span>
            <p className="text-[11px] text-emerald-700 mt-0.5">
              Complete 4 more jobs before Sunday 10 PM to unlock +₹2,000 cash bonus!
            </p>
          </div>
          <div className="w-8 h-8 rounded-full bg-emerald-200 text-emerald-900 font-black flex items-center justify-center shrink-0">
            4/8
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-xs space-y-3">
        <div className="flex items-center justify-between">
          <h3 className="text-xs font-bold uppercase text-gray-700">Recent Transactions</h3>
        ...
        <div className="space-y-2.5">
          {payoutHistory.map((item, idx) => (
            <div
              key={idx}
              className="flex items-center justify-between p-2.5 rounded-xl hover:bg-gray-50 border-b border-gray-50 last:border-0 text-xs"
            >
              <div>
