...
const PrototypeRoot: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-[#EAEFF5] text-[#12222E] flex flex-col relative font-sans selection:bg-[#FF5A5F] selection:text-white">
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative">
        {activePortal === 'admin' ? (
          ...
          <div className="w-full flex-1 flex flex-col items-center justify-center p-0 sm:py-6 sm:px-4">
            ...
            <div className="hidden sm:flex items-center gap-2 mb-3 bg-white/90 backdrop-blur-md px-3.5 py-1.5 rounded-full shadow-xs border border-gray-200/90 text-xs text-gray-600">
            ...
            >
              ...
              {viewMode === 'frame' && (
                <div className="hidden sm:flex items-center justify-between px-6 pt-2 pb-1 bg-white shrink-0 z-40 border-b border-gray-100 select-none">
                  {/* Status Bar Left: Time */}
                  <span className="text-[12px] font-extrabold text-[#12222E] tracking-tight">
                    9:41
                  </span>
                  ...
                  <div className="flex items-center gap-1.5 text-[#12222E]">
              ...
              {viewMode === 'frame' && (
                <div className="hidden sm:flex justify-center pb-1.5 pt-1 bg-white shrink-0 z-40 select-none">
                  <div className="w-28 h-1 bg-gray-400/70 rounded-full"></div>
                </div>
              )}
            </div>
          </div>
